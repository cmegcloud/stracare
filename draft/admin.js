...
const users = [
    { email: "Admin
shain609@gmail.com", pass: "CM02", role: "Owner" },
...
(function initAuth() {
    ...
    if (savedUser) {
        ...
        const sideEmailEl = document.getElementById('sideUserEmail');
        ...
        if(sideRoleEl) sideRoleEl.textContent = `${currentUser.role} Account`;
    } else {
        ...
        if(sideEmailEl) sideEmailEl.textContent = "Not logged in";
        if(sideRoleEl) sideRoleEl.textContent = "---";
    }
})();
